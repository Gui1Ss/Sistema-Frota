...
export default function MotoristaPage() {
  ...
  const createMutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      toast.error(
        error.response?.data?.detail || "Erro ao cadastrar motorista"
      );
    },
  });
  ...
  const updateMutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      toast.error(
        error.response?.data?.detail || "Erro ao atualizar motorista"
      );
    },
  });
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between flex-col sm:flex-row sm:gap-4">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Motoristas</h1>
            <p className="text-slate-600 mt-2">
              Gerenciar motoristas do sistema
            </p>
          </div>
            ...
            <DialogContent className="max-w-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  />
                  {errors.cnh && (
                    <p className="text-sm text-red-600">{errors.cnh}</p>
                  )}
                </div>
                <div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={e =>
                      setFormData({ ...formData, cnhValidade: e.target.value })
                    }
                  />
                </div>
                <div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      <span className="font-medium">CPF:</span> {motorista.cpf}
                    </p>
                    <p className="text-sm text-slate-600">
                      ...
                      <span className="font-bold">
                        ...
                        {motorista.cnhValidade
                          ? new Date(
                              String(motorista.cnhValidade).replace(" ", "T")
