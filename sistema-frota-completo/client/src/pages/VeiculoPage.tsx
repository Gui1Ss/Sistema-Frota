...
import { transformVehicleToApi, transformVehicleFromApi } from "@/lib/apiTransform";
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <Input 
                    ...
                    placeholder="1000"
                  />
                  {errors.capacidade && <p className="text-sm text-red-600">{errors.capacidade}</p>}
                </div>
              ...
              <Card key={veiculo.id} className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-slate-600">Tipo: {veiculo.tipo}</p>
                    <p className="text-sm text-slate-600">Capacidade: {veiculo.capacidade} kg</p>
                  </div>
