...
export default function EntregaPage() {
  ...
  const filteredDeliveries =
    deliveries?.filter((delivery: any) => {
      ...
      const matchesDate =
        !dateFilter || deliveries.createdat.slice(0, 10) > dateFilter;
      ...
      <div className="space-y-6">
        ...
        <Card className="p-4">
          <div className="flex gap-2">
            ...
            {/* <input type="date" className="border p-1 max-h-9 rounded-sm" /> */}
                ...
                {pedidosBuscados.length === 0 ? (
                  <div className="mt-3 flex border-2 p-6 rounded-sm flex-col justify-center items-center">
                    ...
                    <h2 className="text-gray-500 font-light w-[60%] text-center">
                      Digite o código das notas e adicione os para notificar ao
                      cliente
                    </h2>
                  </div>
                ) : (
        ...
        >
          <AlertDialogContent>
            ...
            <AlertDialogDescription>
              ...
              para os clientes das respectivos notas:
            </AlertDialogDescription>
            <div className="flex flex-col w-full gap-2">
              {pedidosBuscados.map((p, i) => (
                <div
